...
//     [BodyMetricIdentifierBicepsLeft isEqualToString: self.identifier] ||
//     [BodyMetricIdentifierBicepsRight isEqualToString: self.identifier] ||
...
//    } else if([BodyMetricIdentifierBicepsLeft isEqualToString: self.identifier]) {
//      name = NSLocalizedString(@"biceps-left-metric-label", @"Biceps - Left");
//    } else if([BodyMetricIdentifierBicepsRight isEqualToString: self.identifier]) {
